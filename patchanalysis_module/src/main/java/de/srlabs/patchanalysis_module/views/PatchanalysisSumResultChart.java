...
/**This UI element visually summarizes the patch analysis test results in a horizontal,rectangular bar chart
...
public class PatchanalysisSumResultChart extends View {
    ...
    //set to true to e.g. see center of drawn parts
    private final boolean PAINT_DEBUG = false;
    ...
    public PatchanalysisSumResultChart(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.PatchanalysisSumResultChart,
                0, 0);

        try {
            showNumbers = a.getBoolean(R.styleable.PatchanalysisSumResultChart_shownumbers, false);
            isSmall = a.getBoolean(R.styleable.PatchanalysisSumResultChart_small, false);
            drawBorder = a.getBoolean(R.styleable.PatchanalysisSumResultChart_drawborder, true);

            //Log.d(Constants.LOG_TAG, "PatchanalysisSumResultChart created: " + (showNumbers ? "showing numbers" : "not showing numbers") + ";" + (isSmall ? "small" : "large"));
        } finally {
            a.recycle();
        }
